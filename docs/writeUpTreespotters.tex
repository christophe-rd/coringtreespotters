...
\caption{Model estimates for each species. We ran a model to estimate the ring width as a function of growing degree days (a metric of heat accumulation that sums the mean daily temperature above some threshold (here: $5^\circ C$)) for the growing season defined between leaf color date and leafout. The very low growing degree day values for Red maple (15350*A, 2022), Sugar maple (22834*B, 2022) and Yellow buckeye (12651*D, 2018) are the result of a very early leaf coloring observation in early June.}
\label{fig:model}
\end{figure}
