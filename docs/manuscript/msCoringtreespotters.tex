...
-0.21, UI:
-0.77,
0.34RW; Figure \ref{fig:tsmuplotayear}; Table \ref{tab:tab_all}). Growth was similar across individual trees (Figure \ref{fig:tsmuplotatreeid}).
