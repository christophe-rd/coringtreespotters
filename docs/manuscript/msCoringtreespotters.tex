...
(0.12, UI:
0.03,
0.21 $\Delta$ RW/scaled GDD; Figure \ref{fig:tsPrvsYr}a; Table \ref{tab:tab_PrvsYr}).

% Paragraph
An earlier start of season did not increase growth for any species and decreased growth for {\Tame} (
0.15, UI:
0.03,
0.27 $\Delta$ RW/scaled SOS; Figure \ref{fig:tsmuplotbspp}c and g; Table \ref{tab:ts_slope_table}), which did not respond to the thermal or the calendar season.

A later end of season did not increase growth for any species and decreased growth for {\Ball} (
-0.09, UI:
-0.16,
-0.01 $\Delta$ RW/scaled EOS; Figure \ref{fig:tsmuplotbspp}d and h; Table \ref{tab:ts_slope_table}), which also decreased growth with warmer thermal season.
