...
$\alpha$ & 0.52 [-2.07, 3.15] & 0.48 [-2.22, 3.17] & 0.23 [-2.53, 2.90] & 0.11 [-2.57, 2.83] \\ 
  ...
  $\alpha_{spp_{A. rubrum}}$ & -0.98 [-4.29, 2.32] & -0.44 [-3.96, 3.07] & -1.07 [-5.06, 2.96] & -1.32 [-6.09, 3.36] \\ 
  $\alpha_{spp_{A. saccharum}}$ & 0.39 [-2.27, 3.05] & 0.60 [-2.16, 3.32] & -2.02 [-5.13, 1.25] & 1.01 [-1.96, 3.85] \\ 
  $\alpha_{spp_{Ae. flava}}$ & -0.22 [-0.78, 0.33] & -0.22 [-0.80, 0.34] & -0.26 [-0.81, 0.28] & -0.23 [-0.79, 0.35] \\ 
  $\alpha_{spp_{B. alleghaniensis}}$ & -0.04 [-0.59, 0.51] & -0.06 [-0.62, 0.51] & -0.00 [-0.55, 0.54] & -0.05 [-0.61, 0.53] \\ 
  $\alpha_{spp_{B. nigra}}$ & 0.03 [-0.52, 0.57] & 0.03 [-0.54, 0.58] & -0.01 [-0.55, 0.53] & 0.04 [-0.52, 0.60] \\ 
  $\alpha_{spp_{C. glabra}}$ & 0.08 [-0.47, 0.61] & 0.06 [-0.51, 0.62] & 0.07 [-0.48, 0.61] & 0.08 [-0.48, 0.65] \\ 
  $\alpha_{spp_{C. ovata}}$ & -0.06 [-0.61, 0.48] & -0.07 [-0.64, 0.49] & -0.13 [-0.68, 0.42] & -0.05 [-0.61, 0.53] \\ 
  $\alpha_{spp_{P. deltoides}}$ & -0.00 [-0.56, 0.55] & -0.00 [-0.57, 0.55] & 0.01 [-0.55, 0.54] & 0.01 [-0.55, 0.58] \\ 
  $\alpha_{spp_{Q. alba}}$ & -0.06 [-0.62, 0.50] & -0.08 [-0.65, 0.49] & -0.08 [-0.64, 0.48] & -0.06 [-0.61, 0.51] \\ 
  $\alpha_{spp_{Q. rubra}}$ & 0.19 [-0.36, 0.74] & 0.18 [-0.39, 0.76] & 0.20 [-0.36, 0.73] & 0.19 [-0.37, 0.77] \\ 
  $\alpha_{spp_{T. americana}}$ & 0.08 [-0.48, 0.63] & 0.08 [-0.51, 0.65] & 0.07 [-0.49, 0.62] & 0.10 [-0.48, 0.68] \\ 
   \hline
\end{tabular}
\end{table}
