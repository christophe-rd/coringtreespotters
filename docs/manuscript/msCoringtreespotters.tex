...
($\beta =$ 0.15, UI:
0.02,
0.28 RW/GDD). {\Ball}'s congeneric {\Bnig}, also grew less with previous year GDD ($\beta =$ 
-0.08, UI:
-0.17,
-0.00 RW/GDD; Figure \ref{fig:tsPrvsYr}b; Table \ref{tab:tab_PrvsYr}) but in contrast, current year GDD increased growth for that species ($\beta =$ 
0.12, UI:
0.03,
