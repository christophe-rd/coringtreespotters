...
# removed phoperiod column from the code because it doesn't exist
bb.pheno<-dplyr::select(bb, Genus, Species, Common_Name, phase, lat, long, elev, year, doy, numYs, ID, AGDD)
