...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
##### Recover b spp #####
bspp_cols <- colnames(df_fit)[grepl("bspp", colnames(df_fit))]
...
plot(emp$pgsGDD5, y, type = "n", 
     ylim = range(min(emp$lengthMM*10), max(emp$lengthMM*10)), 
     xlab = "Primary growing season GDD", ylab = "Ring width (mm)",
